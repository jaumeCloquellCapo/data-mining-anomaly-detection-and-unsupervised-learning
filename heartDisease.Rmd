...
El primer paso es el proceso de limpieza de datos para eliminar posibles valores faltante en el conjunto de datos, luego discretizar posibles variables continuas.  Comprobamos la presencia de N.A. Solo 6 casos presentan símptomas de tener missing values, por ello seran eliminados del dataser
```{r}
...
Usamos apriori para obtener los itemsets frecuentees. Primera información importante que **sex=male** o **fasting_blood_sugar=false** es muy frecuente. En el barplot se muestran los tamaños de itemsets frecuentes. Se ve cómo el tamaño de itemsets más frecuente es 4.
